  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute left-0 top-0 h-[350px] w-[350px] rounded-full bg-[var(--primary)]/5 blur-[120px]" />
        <div className="absolute bottom-0 right-0 h-[350px] w-[350px] rounded-full bg-blue-100/40 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <div className="max-w-4xl">
          ...
          <h2 className="mt-5 text-4xl font-bold leading-[0.95] tracking-[-0.04em] text-slate-900 md:text-6xl xl:text-[58px]">
            Built Across
            <br />
            Multiple
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          {capabilities.map((item, index) => {
            ...
            return (
              <div
                key={item.title}
                className="group overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm transition-all duration-500 hover:shadow-lg hover:border-[var(--primary)]/30"
              >
                <div className="grid md:grid-cols-[0.4fr_0.6fr]">
                  ...
                  <div className="flex flex-col justify-between p-5 md:p-6">
                    ...
                    <Link
                      href="/contact"
                      className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[var(--primary)] transition-all hover:gap-3"
                    >
                      Explore Capability
                      <ArrowRight size={15} />
                    </Link>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h3 className="text-xl font-bold leading-tight text-slate-900 md:text-2xl">
                Contract Manufacturing, Third-Party Production &
            ...
            <Link
              ...
              className="flex items-center gap-2 rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white transition hover:scale-[1.02]"
            >
